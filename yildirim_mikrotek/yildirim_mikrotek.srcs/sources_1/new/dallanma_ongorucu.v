...
module dallanma_ongorucu (
   ...
   output  [31:0]               ongoru_o,  // Nereye atlayacaðý --- Getir 1'e giden sinyal

   input   [31:0]               yurut_ps_i,
   input                        yurut_guncelle_i, // dallanma buyruðuysa yürütten güncelleme gelecek
   input                        yurut_atladi_i, // atladý mi bilgisi
   input   [31:0]               yurut_atlanan_adres_i, // eðer dallanma atladýysa target neresi bilgisi TODO: yürüte eklenecek
   input                        yurut_hatali_tahmin_i  // hatalý tahmin
...
always @* begin 
    ...
    if (yurut_guncelle_i) begin
      ...
      BTB_ns [yurut_ps_i[`BTB_PS_BIT-1:0]][`BTB_VALID_BITI]         = 1'b1; // ;BTB_VALID_BITI GÜNCELLEMESÝ
      BTB_ns [yurut_ps_i[`BTB_PS_BIT-1:0]][`BTB_VALID_BITI-1:32]    = yurut_ps_btb_etiket_w; // BTB_ETIKET GÜNCELLEMESÝ
      BTB_ns [yurut_ps_i[`BTB_PS_BIT-1:0]][31:0]                    = yurut_atlanan_adres_i; // SADECE ATLADIYSA TARGET GÜNCELLENMELÝ, ATLAMADIYSA 0 YAPMALI MIYIZ???
      end
      BHT_ns [yurut_ps_i[`BHT_PS_BIT-1:0]^GGY_r][`BHT_SATIR_BOYUT-1:`DALLANMA_TAHMIN_BIT]   = yurut_ps_bht_etiket_w; // BHT_ETIKET 
      BHT_ns [yurut_ps_i[`BHT_PS_BIT-1:0]^GGY_r][`DALLANMA_TAHMIN_BIT-1:0]                  = yurut_atladi_i ? // BHT_DALLANMA_TAHMINI GÜNCELLEMESÝ
