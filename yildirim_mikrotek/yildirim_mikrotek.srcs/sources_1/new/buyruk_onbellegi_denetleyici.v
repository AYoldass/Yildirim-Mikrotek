...
reg [$clog2(`L1B_YOL)-1:0]          cikarma_sayaci_r;  //geri donmeyen durumlar için sayac
...
always @* begin
   ...
   l1_istek_yaz_ns              = {`L1B_YOL{1'b0}}; // Tek cevrim 1 olmali
