...
HD_PWD='C:/Users/senan/Desktop/Graduation-Project/yildirim_mikrotek/yildirim_mikrotek.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log carp_biriktir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source carp_biriktir.tcl
