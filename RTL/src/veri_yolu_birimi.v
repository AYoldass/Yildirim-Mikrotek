...
always @* begin
   ...
   ISTEK: begin
      port_istek_gecerli_ns = 1'b1;
      // NOT: port_istek_gecerli_o yerine _ns okunur (always@* kendi surekli-atama
      // cikisini okuyunca iverilog'da yakinsamayan delta-dongusu olusur).
      if (port_istek_gecerli_ns && port_istek_hazir_i) begin
   ...
   BEKLE: begin
      ...
      if (port_veri_gecerli_i && port_veri_hazir_ns) begin
...
// port_veri_hazir KAYITLI verilir: L1 (veri_onbellegi_denetleyici) always@* blogu
// ile bu blok arasinda okuma-veri el-sikismasi (port_veri_hazir <-> port_veri_gecerli)
// KOMBINASYONEL surulurse iverilog'da yakinsamayan olay-pingpongu olusuyordu. Bu yon
// kaydedilince dongu yolu kirilir; vyb ic mantigi yine _ns kullandigindan veri yakalama
// ayni cevrimde olur (L1 sadece hazir'i bir cevrim gec gorur, gecerli'yi gec birakir).
