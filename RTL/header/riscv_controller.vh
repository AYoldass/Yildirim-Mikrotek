...
`define BIB       21:19
`define SYS       24:22
`define BMANIP    25:25     // bit-manipulasyon (B) birimine yonlendir

// SYS alani: sistem/trap kontrolu (Faz 5). BIRIM_CSR ayrica CSR oku/yaz icin.
`define SYS_YOK     3'd0
`define SYS_ECALL   3'd1
`define SYS_EBREAK  3'd2
`define SYS_MRET    3'd3
`define SYS_ILLEGAL 3'd4
